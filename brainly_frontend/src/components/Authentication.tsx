...
export default function Authentication(props: ModalProps) {
    ...
    async function submitLoginHandler(){
        setIsLoading(false)
        const result = await fetch("https://brainly-backend-sepia.vercel.app/api/v1/signin", {
            method: "POST",
            headers: new Headers({
    ...
    async function submitRegisterHandler(){
        setIsLoading(false)
        const result = await fetch("https://brainly-backend-sepia.vercel.app/api/v1/signup", {
            method: "POST",
            headers: new Headers({
                "Content-Type": "application/json",
            }),
